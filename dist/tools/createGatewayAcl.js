...
export function registerCreateGatewayAclTool(server, client) {
    server.registerTool('createGatewayAcl', {
    ...
    }, wrapMutationToolHandler('createGatewayAcl', ({ siteId }, result, mode) => ({
...
//# sourceMappingURL=createGatewayAcl.js.map