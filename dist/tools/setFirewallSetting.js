...
export function registerSetFirewallSettingTool(server, client) {
    server.registerTool('setFirewallSetting', {
        description: 'Update site firewall settings through the official Omada Open API with dry-run preview support.',
        inputSchema: inputSchema.shape,
        annotations: {
            destructiveHint: true,
        },
    }, wrapMutationToolHandler('setFirewallSetting', ({ siteId }, result, mode) => ({
...
//# sourceMappingURL=setFirewallSetting.js.map