...
export function registerBlockClientTool(server, client) {
    ...
    server.registerTool('blockClient', {
        description: 'Block a client from network access through the official Omada Open API.',
        inputSchema: inputSchema.shape,
        annotations: {
            destructiveHint: true,
        },
    }, wrapMutationToolHandler('blockClient', ({ clientMac, siteId }, result, mode) => ({
        action: 'block-client',
        target: clientMac,
        siteId,
        mode,
...
//# sourceMappingURL=blockClient.js.map