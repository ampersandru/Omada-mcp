...
export function registerGetRogueApExportTool(server, client) {
    ...
    server.registerTool('getRogueApExport', {
        description: 'Export Rogue AP scan results for a site. Returns detected rogue access points in CSV or Excel format.',
        inputSchema: inputSchema.shape,
    }, wrapToolHandler('getRogueApExport', async ({ siteId, format, page, pageSize, customHeaders }) => toToolResult(await client.getRogueApExport(siteId, format, page, pageSize, customHeaders))));
}
//# sourceMappingURL=getRogueApExport.js.map