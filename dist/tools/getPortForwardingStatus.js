 ...
 */
function normalisePortForwardingType(raw) {
...
export function registerGetPortForwardingStatusTool(server, client) {
    ...
    server.registerTool('getPortForwardingStatus', {
        description: 'Get port forwarding status and rules for a site. Retrieves either User-configured or UPnP-discovered port forwarding rules. Both page and pageSize parameters are required by the API. Call this tool twice (once with type="User" and once with type="UPnP") to get complete port forwarding information.',
...
//# sourceMappingURL=getPortForwardingStatus.js.map