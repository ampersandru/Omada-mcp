...
export function registerBackupControllerToFileServerTool(server, client) {
    ...
    server.registerTool('backupControllerToFileServer', {
        description: 'Trigger a controller configuration backup to an external file server (FTP/SFTP). Use getBackupResult to poll the backup status.',
        inputSchema: inputSchema.shape,
        annotations: {
            destructiveHint: false,
        },
    }, wrapMutationToolHandler('backupControllerToFileServer', ({ filePath }, result, mode) => ({
...
//# sourceMappingURL=backupControllerToFileServer.js.map