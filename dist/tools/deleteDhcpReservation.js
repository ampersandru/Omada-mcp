...
export function registerDeleteDhcpReservationTool(server, client) {
    ...
    server.registerTool('deleteDhcpReservation', {
        description: 'Delete an existing DHCP reservation by MAC address.',
        inputSchema: inputSchema.shape,
        annotations: {
            destructiveHint: true,
        },
    }, wrapMutationToolHandler('deleteDhcpReservation', ({ reservationMac, siteId }, result, mode) => ({
...
//# sourceMappingURL=deleteDhcpReservation.js.map