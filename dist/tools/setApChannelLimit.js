...
export function registerSetApChannelLimitTool(server, client) {
    server.registerTool('setApChannelLimit', {
        description: 'Update channel-limit settings for a specific Omada access point after checking feature support.',
        inputSchema: inputSchema.shape,
        annotations: {
            destructiveHint: true,
        },
    }, wrapMutationToolHandler('setApChannelLimit', ({ apMac, siteId }, result, mode) => ({
        ...
        const current = (await client.getSitesApsChannelLimit(apMac, siteId, customHeaders));
...
//# sourceMappingURL=setApChannelLimit.js.map