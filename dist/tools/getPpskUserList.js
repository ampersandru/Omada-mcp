...
export function registerGetPpskUserListTool(server, client) {
    server.registerTool('getPpskUserList', {
    ...
    }, wrapToolHandler('getPpskUserList', async ({ profileId, siteId, customHeaders }) => toToolResult(await client.getPpskUserGroup(profileId, siteId, customHeaders))));
}
//# sourceMappingURL=getPpskUserList.js.map