...
export function registerRebootDeviceTool(server, client) {
    ...
    server.registerTool('rebootDevice', {
        description: 'Reboot a managed device through the official Omada Open API.',
        inputSchema: inputSchema.shape,
        annotations: {
            destructiveHint: true,
        },
    }, wrapMutationToolHandler('rebootDevice', ({ deviceMac, siteId }, result, mode) => ({
...
//# sourceMappingURL=rebootDevice.js.map