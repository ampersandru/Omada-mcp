...
export function registerSetAccessControlTool(server, client) {
    server.registerTool('setAccessControl', {
        description: 'Update portal access control settings with dry-run preview support using the official Omada Open API access control schema.',
        inputSchema: setAccessControlInputSchema.shape,
        annotations: {
            destructiveHint: true,
        },
    }, wrapMutationToolHandler('setAccessControl', ({ siteId }, result, mode) => ({
...
//# sourceMappingURL=setAccessControl.js.map