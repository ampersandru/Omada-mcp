...
export function registerListSiteThreatManagementTool(server, client) {
    ...
    server.registerTool('listSiteThreatManagement', {
        description: 'List site-level threat management events detected by IPS, with optional time range and keyword filtering.',
        inputSchema: inputSchema.shape,
    }, wrapToolHandler('listSiteThreatManagement', async (args) => toToolResult(await client.listSiteThreatManagement({
        page: args.page,
...
//# sourceMappingURL=listSiteThreatManagement.js.map