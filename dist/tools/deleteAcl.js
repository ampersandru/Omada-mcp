...
export function registerDeleteAclTool(server, client) {
    server.registerTool('deleteAcl', {
    ...
    }, wrapMutationToolHandler('deleteAcl', ({ aclId, siteId }, result, mode) => ({
        action: 'delete-acl',
        target: aclId,
        siteId,
        mode,
...
//# sourceMappingURL=deleteAcl.js.map