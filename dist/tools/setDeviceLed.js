...
export function registerSetDeviceLedTool(server, client) {
    ...
    server.registerTool('setDeviceLed', {
        description: 'Change the LED state for a managed device through the official Omada Open API.',
        inputSchema: inputSchema.shape,
    }, wrapMutationToolHandler('setDeviceLed', ({ deviceMac, ledSetting, siteId }, result, mode) => ({
...
//# sourceMappingURL=setDeviceLed.js.map