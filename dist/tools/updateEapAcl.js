...
export function registerUpdateEapAclTool(server, client) {
    server.registerTool('updateEapAcl', {
    ...
    }, wrapMutationToolHandler('updateEapAcl', ({ aclId, siteId }, result, mode) => ({
...
//# sourceMappingURL=updateEapAcl.js.map