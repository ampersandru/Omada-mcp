...
import { createEapAclInputSchema, eapAclPayloadSchema, findCreatedAclByDescription, getAclRecordId, validateEapAclPayloadReferences, } from './gatewayAclShared.js';
export function registerCreateEapAclTool(server, client) {
    server.registerTool('createEapAcl', {
    ...
    }, wrapMutationToolHandler('createEapAcl', ({ siteId }, result, mode) => ({
...
//# sourceMappingURL=createEapAcl.js.map