...
export function registerReconnectClientTool(server, client) {
    ...
    server.registerTool('reconnectClient', {
        description: 'Force a client to reconnect through the official Omada Open API.',
        inputSchema: inputSchema.shape,
        annotations: {
            destructiveHint: true,
        },
    }, wrapMutationToolHandler('reconnectClient', ({ clientMac, siteId }, result, mode) => ({
...
//# sourceMappingURL=reconnectClient.js.map