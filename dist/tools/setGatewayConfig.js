...
async function getGatewaySummary(client, gatewayMac, siteId, customHeaders) {
...
async function getCurrentGatewayConfig(client, configType, gatewayMac, siteId, customHeaders) {
...
async function applyGatewayConfig(client, configType, gatewayMac, payload, siteId, customHeaders, portName) {
    switch (configType) {
        case 'general-config':
...
export function registerSetGatewayConfigTool(server, client) {
    server.registerTool('setGatewayConfig', {
        description: 'Update a documented Omada gateway configuration family with dry-run support. Covers general, services, advanced, radios, WLAN, and port settings through the official Open API.',
        inputSchema: inputSchema.shape,
        annotations: {
            destructiveHint: true,
        },
    }, wrapMutationToolHandler('setGatewayConfig', ({ gatewayMac, configType, siteId }, result, mode) => ({
...
//# sourceMappingURL=setGatewayConfig.js.map