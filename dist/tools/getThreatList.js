...
export function registerGetThreatListTool(server, client) {
    ...
    server.registerTool('getThreatList', {
        description: 'Get the global view threat management list. Returns paginated threat information including severity, source/destination IPs, countries, classification, and more.',
...
//# sourceMappingURL=getThreatList.js.map