...
export function registerBackupSitesToFileServerTool(server, client) {
    ...
    server.registerTool('backupSitesToFileServer', {
        description: 'Trigger a multi-site configuration backup to an external file server (FTP/SFTP, up to 300 sites). Use getSiteBackupResult to poll the backup status for a specific site.',
        inputSchema: inputSchema.shape,
        annotations: {
            destructiveHint: false,
        },
    }, wrapMutationToolHandler('backupSitesToFileServer', ({ siteIds, filePath }, result, mode) => ({
...
//# sourceMappingURL=backupSitesToFileServer.js.map