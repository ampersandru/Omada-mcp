...
export function registerGetNetworkHealthSummaryTool(server, client) {
    server.registerTool('getNetworkHealthSummary', {
        description: 'Composite health snapshot — single call that combines dashboard overview (device/client counts, connectivity), internet/WAN status, client distribution, and recent active threats. Use this as the first call when checking if everything is working or when starting any troubleshooting session. Individual sections gracefully degrade if an endpoint is unavailable.',
...
//# sourceMappingURL=getNetworkHealthSummary.js.map