...
export function registerGetSwitchVlanInterfaceTool(server, client) {
    server.registerTool('getSwitchVlanInterface', {
        description: 'Get VLAN interface configuration for a specific switch. Requires `switchMac`.',
        inputSchema: inputSchema.shape,
    }, wrapToolHandler('getSwitchVlanInterface', async ({ switchMac, siteId, customHeaders }) => toToolResult(await client.getSwitchVlanInterface(switchMac, siteId, customHeaders))));
}
//# sourceMappingURL=getSwitchVlanInterface.js.map