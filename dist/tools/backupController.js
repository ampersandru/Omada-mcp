...
export function registerBackupControllerTool(server, client) {
    ...
    server.registerTool('backupController', {
        description: 'Trigger a controller configuration backup to the self/cloud server. Use getBackupResult to poll the backup status afterwards.',
        inputSchema: inputSchema.shape,
        annotations: {
            destructiveHint: false,
        },
    }, wrapMutationToolHandler('backupController', ({ retainUser }, result, mode) => ({
