...
export function registerDeleteBandwidthControlRuleTool(server, client) {
    server.registerTool('deleteBandwidthControlRule', {
        description: 'Delete an existing bandwidth control rule with dry-run preview support.',
        inputSchema: inputSchema.shape,
        annotations: {
            destructiveHint: true,
        },
    }, wrapMutationToolHandler('deleteBandwidthControlRule', ({ ruleId, siteId }, result, mode) => ({
...
//# sourceMappingURL=deleteBandwidthControlRule.js.map