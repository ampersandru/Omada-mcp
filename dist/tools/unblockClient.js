...
export function registerUnblockClientTool(server, client) {
    ...
    server.registerTool('unblockClient', {
        description: 'Restore a blocked client to network access through the official Omada Open API.',
        inputSchema: inputSchema.shape,
        annotations: {
            destructiveHint: true,
        },
    }, wrapMutationToolHandler('unblockClient', ({ clientMac, siteId }, result, mode) => ({
...
//# sourceMappingURL=unblockClient.js.map