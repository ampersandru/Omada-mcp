...
export function registerDeleteAppControlRuleTool(server, client) {
    server.registerTool('deleteAppControlRule', {
        description: 'Delete an existing application control rule with dry-run preview support.',
        inputSchema: inputSchema.shape,
        annotations: {
            destructiveHint: true,
        },
    }, wrapMutationToolHandler('deleteAppControlRule', ({ ruleId, siteId }, result, mode) => ({
...
//# sourceMappingURL=deleteAppControlRule.js.map