...
export function registerUpdateGatewayAclTool(server, client) {
    server.registerTool('updateGatewayAcl', {
    ...
    }, wrapMutationToolHandler('updateGatewayAcl', ({ aclId, siteId }, result, mode) => ({
...
//# sourceMappingURL=updateGatewayAcl.js.map